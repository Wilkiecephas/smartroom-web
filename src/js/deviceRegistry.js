...
export const AVAILABLE_SENSORS_CATALOG = [
  ...
  { id: 'aux_relay', name: '5V/3.3V Relay Switch Actuator (Lights/Fans)', icon: '🔌', bus: 'Digital Out (Pin D7)', category: 'Actuator' },
  { id: 'mq2_gas', name: 'MQ-2 Flammable Gas & Smoke Sensor', icon: '☁️', bus: 'Analog ADC (Pin A3)', category: 'Safety & Gas' },
  { id: 'flame_detector', name: 'Infrared Optical Flame & Fire Detector', icon: '🔥', bus: 'Analog (A7) / Digital (D3)', category: 'Safety & Fire' },
  { id: 'soil_moisture', name: 'Capacitive / Resistive Soil Hygrometer', icon: '🌱', bus: 'Analog ADC (Pin A6)', category: 'Environment' },
  { id: 'ky038_sound', name: 'High-Sensitivity Acoustic Sound / Noise Sensor', icon: '🎙️', bus: 'Analog (A6) / Digital (D3)', category: 'Acoustics' },
  { id: 'mhz19b_co2', name: 'MH-Z19B NDIR High-Precision CO2 Gas Sensor', icon: '💨', bus: 'UART Serial (TX/RX)', category: 'Air Quality' },
  { id: 'ds18b20_temp', name: 'DS18B20 Waterproof Digital Thermometer', icon: '🌡️', bus: '1-Wire Digital (Pin D3)', category: 'Temperature' },
  { id: 'rgb_led', name: 'Tricolor RGB Cyber Indicator LED', icon: '🔴', bus: 'PWM (Pin D7 / Expansion)', category: 'Indicator' },
